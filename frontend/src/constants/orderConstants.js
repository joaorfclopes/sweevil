...
export const ORDER_DISMISS_REFUND_REQUEST = 'ORDER_DISMISS_REFUND_REQUEST';
export const ORDER_DISMISS_REFUND_SUCCESS = 'ORDER_DISMISS_REFUND_SUCCESS';
export const ORDER_DISMISS_REFUND_FAIL = 'ORDER_DISMISS_REFUND_FAIL';
export const ORDER_DISMISS_REFUND_RESET = 'ORDER_DISMISS_REFUND_RESET';
