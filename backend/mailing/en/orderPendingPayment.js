    ...
    <tbody>
      ...
      <tr>
        <td style="padding:40px 40px 24px;">
          <h1 style="margin:0 0 8px;font-size:22px;color:#1a1a1a;">Order at ${brand}</h1>
          <p style="margin:0 0 24px;color:#555;font-size:15px;">
            Hi ${name}, your order has been created and is awaiting payment.
          ...
          <p style="margin:0;color:#999;font-size:13px;">
            This link is exclusive to your order. Do not share it with anyone.
          </p>
        </td>
      </tr>
      <tr>
        <td style="background:#f9f9f9;padding:24px;text-align:center;border-top:1px solid #e0e0e0;">
          ...
          <p style="margin:0;color:#bbb;font-size:12px;">${brand}® is a registered trademark</p>
        </td>
      </tr>
    </tbody>
  </table>
